      ...
      <div className="max-2-3xl mx-auto px-4">
        ...
        <div className="glass rounded-xl p-8 border-white/10 border hocer:-translate-y-1 transition-all">
          <p className="text-gray-300 mb-6 w-2/3 mx-auto text-center">
            ...
            laboriosam beatae similique dolorum, cum facere nihil, quae at iusto
            obcaecati itaque deleniti praesentium consequatur nemo voluptatem!
            Et itaque quas officia.
          </p>
            ...
            <div className="space-y-4 text-gray-300">
              <div>
                ...
                <p>
                  ...
                  participants transitioning into tech careers. Guided students
                  through ServiceNow development, administration, and hands-on
                  exercises. Provided support in troubleshooting, debugging, and
                  applying best practices. Helped facilitate discussions,
                  workshops, and real-world project applications.
                </p>
              </div>
              <div>
                <h4 className="font-semibold mb-2">
                ...
                <p>
                  ...
                  Built and deployed custom applications using React, HTML, CSS,
                  and a variety of other languages. Collaborated on real-world
                  projects, focusing on best coding practices in an agile
                  environment. Assisted in teaching and mentoring peers in web
                  development to include testing and debugging.
                </p>
              </div>
              <div>
                <h4 className="font-semibold mb-2">
                ...
                <p>
                  ...
                  NAVAIR regulations. Supervised and trained Marines in ordnance
                  handling, maintenance, and safety procedures. Managed risk
                  assessments and enforced strict adherence to operational
                  standards.
                </p>
              </div>
            </div>
